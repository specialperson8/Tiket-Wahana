        ...
        <div class="card-body">
          ...
          ?>
              <div class="alert alert-danger" role="alert">
                ...
                <p class="mb-0">Untuk menyelesaikan pembayaran ini, silakan menuju ke loket dan tunjukan halaman ini.</p>
              </div>
              <hr>
            <?php
          ...
          ?>
            <div class="alert alert-success" role="alert">
              ...
              <p class="mb-0">Silahkan tunjukan halaman ini di loket untuk mendapatkan tiket</p>
            </div>
            <b>Nomor Pesanan Anda</b> : <span class="badge badge-primary"><?= $detail->nomor_pesanan ?></span>
            <hr>
          <?php
          }
          ?>
