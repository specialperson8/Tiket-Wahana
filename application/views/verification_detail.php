    ...
    <div class="col-md-12" style="margin-top: 60px;">
      <div class="card">
        ...
        <div class="card-body">
          ...
          ?>
            <div class="form-group">
              <label class="text-purple text-bold">Nomor Pesanan</label>
              <p><span class="badge badge-primary"><?= $detail->nomor_pesanan ?></span></p>
            </div>
          <?php
          }
          ?>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label class="text-purple text-bold">Tanggal Booking</label>
                <p><?= tanggal($detail->tgl_booking) ?></p>
              </div>
              <!--<div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label class="text-purple text-bold">Destinasi</label>
                <p><?= $detail->nama_wahana ?> - <?= $detail->nama_destinasi ?></p>
              </div>
              <div class="form-group">
                <label class="text-purple text-bold">Paket</label>
                <p><?= $detail->jumlah_paket ?> Orang</p>
              </div>
          ...
          ?>
            ...
            <a href="<?= base_url('order/verification_detail/' . $detail->id_transaksi . '/reject') ?>" class="btn btn-danger">Tolak</a>
          <?php
          } else {
          ?>
...
<div class="modal fade" id="terimaModal" tabindex="-1" role="dialog" aria-labelledby="terimaModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="terimaModalLabel">Input Nomor Pesanan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form method="POST" action="<?= base_url('order/verification_detail/' . $detail->id_transaksi . '/accept') ?>">
          <div class="form-group">
            <label>Nomor Pesanan</label>
            <input type="text" class="form-control" name="nomor_pesanan">
          </div>
      </div>
      <div class="modal-footer">
