...
<head>
  ...
  <title>UMM Park</title>
</head>

<body>

  <div class="navbar-title">
    <span class="head1">UMM</span><span class="head2">Park</span>
    <p>Datang dan<span class="underline"> nikmati keseruannya</span></p>
  </div>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        ?>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('apartement') ?>">Data Destinasi</a>
          </li>
          <li class="nav-item">
